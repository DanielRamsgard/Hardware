...
#ifdef DEBUG
#define DBGSTR(message)     mySerial.print(message)
#define DBGBUF(buf, len)	mySerial.write(buf, len)
#define DBGLN(message)		mySerial.println(message)
#define DBGFMT(msg, fmt)	mySerial.print(msg, fmt)
#define DBGCHAR(c)			mySerial.write(c)
#else
#define DBG(message)
#endif // DEBUG
